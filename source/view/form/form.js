...
define(function(require, exports, module) {
  ...
  // core modules
  var component = require('ui/view/form/component');
  var event = require('ui/view/form/event');
  var key = require('ui/view/form/key');
  var utils = require('ui/view/form/utils');

  // ui module
  var DialogWindow = require('ui/window/dialog');

  // plugin modules
  var Attachments = require('ui/view/form/module/attachments');
  var Control = require('ui/view/form/module/control');
  var Charges = require('ui/view/form/module/charges');
  var Collapse = require('ui/view/form/module/collapse');
  var Comments = require('ui/view/form/module/comments');
  var Contact = require('ui/view/form/module/contacts');
  var Currency = require('ui/view/form/module/currency');
  var Date = require('ui/view/form/module/date');
  var File = require('ui/view/form/module/file');
  var Hour = require('ui/view/form/module/hour');
  var Hours = require('ui/view/form/module/hours');
  var Iframe = require('ui/view/form/module/iframe');
  var Items = require('ui/view/form/module/items');
  var List = require('ui/view/form/module/list');
  var Logs = require('ui/view/form/module/logs');
  var Validator = require('ui/view/form/module/validator');
  //var Nodes = require('ui/view/form/nodes');
  var Product = require('ui/view/form/module/product');
  var Reference = require('ui/view/form/module/reference');
  var Related = require('ui/view/form/module/related');
  var Textarea = require('ui/view/form/module/textarea');
  var Unique = require('ui/view/form/module/unique');
  var Url = require('ui/view/form/module/url');
